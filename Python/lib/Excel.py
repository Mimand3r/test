...
from lib.SendeModul import InfoMessages, sende_nachricht
...
def erstelle_excel_datei(ergebnis_ordner):
    ...
    # BspOut: datetime.datetime.now().__str__() -> 2018-10-17 12:18:43.461799
    datei_name_excel = datetime.datetime.now().date().__str__()
    # datei_name_excel = datei_name_excel.split("-")[:2]
    # datei_name_excel = "Tickets-{}-{}".format(datei_name_excel[0], datei_name_excel[1])
